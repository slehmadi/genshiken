...
label scene_1:
    ...
    play music "audio/Musics/1-[Kelas] Slow Steps.mp3" volume 0.005

    "VTuber agency is not rare nowadays"
    "In a room, sit two people facing each other, a girl and a man with suit."
    "..."

    voice "<from 0.0 to 4.35>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 5.5 to 9>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 11.2 to 18>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 19 to 21.59>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 22 to 31>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 33 to 38>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 40 to 48.8>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 50 to 57.5>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
    ...
    voice "<from 57.55>audio/Dubs/Interviewer/Scene 1_Interviewer_Final.mp3"
