...
label scene_13A:
    scene bg outside art

    "*Callista went as quickly as she can to the Art Convention Building*"

    #show callista normal

    j "Oh no, I’m late."

    scene bg art convetion
    ...
    "*Callista looks at the room, but there’s something missing*"
    ...
    j "*Lucky suddenly sick? That’s weird*"
    ...
    "*Bisma went on to tell Callista all of his ideas.*"
    ...
    "*They both walk to the stage and prepare their instruments*"
    ...
    "*They played harmoniously until the end*"
    "*Bisma can’t stop looking at Callista*"
